      ...
      <div className="overflow-x-hidden">
        ...
        <div className="z-0">
          <img
            ...
            src="https://asset.gecdesigns.com/img/background-templates/isometric-landing-page-design-background-template-1612199755792-cover.webp"
            alt=""
          />
        </div>
        <div className="home absolute top-32 mt-10 w-[50%] px-36">
          <div className="">
            <h1 className="text-5xl text-white font-serif mb-8">
              Aggregator Website for Career Development
            </h1>
            <p className="text-md text-white mb-8">
              Explore your career potential with our aggregator website for
              career development and placement preparation. Access a curated
              selection of resources, including job listings, interview tips,
              and industry insights, all in one convenient platform. Elevate
              your career prospects and prepare for success with our
              comprehensive career development tools and resources
            </p>
            <div className="flex justify-between font-serif">
              <a
                className="bg-gradient-to-t from-orange-500 via-orange-600 to-orange-700 text-white px-8 py-4 rounded-lg hover:-translate-y-2 ease-in-out duration-300"
                href="#"
              >
                View Test Patterns
              </a>
        ...
        <div className="about px-5 mt-10 w-full">
          <div className="text-center">
            ...
            <div className="flex justify-center mb-7">
              <hr className="bg-orange-600 pt-0.5 w-[7%] " />
            </div>
            <h1 className="">
            ...
            <div className="grid grid-cols-3 gap-3 z-10 ">
              <div className="ml-24 col-span-2 mt-5">
                ...
                <div className="flex gap-5 px-5">
                  <div className="px-10 py-7 m-5 bg-white shadow-xl rounded-l-3xl rounded-br-3xl hover:text-white hover:bg-gradient-to-t from-orange-600  to-orange-800 transition duration-700 ease-in-out">
        ...
        <div className="watch px-40 py-20 mt-32 bg-gradient-to-t from-orange-700 to-orange-800 w-full grid grid-cols-3 gap-3">
          ...
          <div className="flex justify-center items-center relative">
            <BsFillPlayCircleFill
              size={50}
              className="absolute fill-orange-700 animate-pulse"
            />
            <img
              className=" w-[90%]"
            ...
            <div className="shadow-xl rounded-lg w-80">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-12">
                  <div className="flex">
                    <AiFillClockCircle className="scale-110 mt-1 mr-1 fill-orange-700" />
                    <h1 className="">30 Aug 2023</h1>
                  </div>
                  <div className="flex">
                    <FaUserCheck className="scale-110 mt-1 mr-1 fill-orange-700" />
                ...
                <div className="mb-2 mt-3 inline-block hover:-translate-y-2 ease-in-out duration-300">
                  <a
                    className="bg-gradient-to-t from-orange-500 to-orange-800 text-white px-8 py-3 rounded-md"
                    href="#"
                  >
                    Read More
                  </a>
        ...
        <div className="number bg-gradient-to-t  from-orange-700 to-orange-800 px-5 py-20 mt-16 flex justify-evenly gap-2">
        ...
        <div className="contact mt-4 py-20">
          ...
          <div className="grid grid-cols-3 mx-40 gap-14">
            <div className="grid grid-rows-3 gap-8 ml-12">
              <div className="flex">
                <div className="">
                  <AiOutlineHome
                    size={40}
                    className="bg-gradient-to-t from-orange-500 to-orange-800 fill-white p-2 rounded-md"
                  />
                </div>
            ...
            <div className="">
              ...
              <div>
                <a
                  className="bg-gradient-to-t from-orange-500 to-orange-800 text-white rounded-lg px-32 py-3"
                  href="#"
                >
                  Send Message
                </a>
