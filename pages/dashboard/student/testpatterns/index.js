            ...
            {tab === "Service Companies" && (
              ...
              >
                {companies.filter((company) => company.jobtype === "Service Companies").map((product,index) => (
                    <div className="w-25 h-25 sm:w-30 sm:h-30 md:w-35 md:h-35 lg:w-46 lg:h-50 xl:w-56 xl:h-60 rounded shadow  py-6 group relative flex flex-col justify-between cursor-pointer">
                    <Link
            ...
            {tab === "Product/Super Dream" && (
               ...
               >
                     {companies.filter((company) => company.jobtype === "Product/Super Dream").map((product,index) => (
                          <div className="w-25 h-25 sm:w-30 sm:h-30 md:w-35 md:h-35 lg:w-46 lg:h-50 xl:w-56 xl:h-60 rounded shadow py-7 group relative flex flex-col justify-between cursor-pointer">
                          <Link
                            href={`/dashboard/student/testpatterns/${product.companyname}`}
                          >
                            <div className="h-[100%]">
