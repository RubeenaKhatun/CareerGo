...
const ResumeIndex = ({ user, companies }) => {
  ...
  const tabs = [
    ...
    {
      name: "Product/Dream Companies",
      current: tab === "Product/Dream Companies",
    },
        ...
        <main className="px-8 relative mt-[10vh]">
          ...
          <section className="my-10">
            {tab === "Service Companies" && (
              ...
              >
                {companies
                  .filter((company) => company.jobtype === "Service Companies")
                  .map((product, index) => (
                    <div className="w-25 h-25 sm:w-30 sm:h-30 md:w-35 md:h-35 lg:w-46 lg:h-50 xl:w-56 xl:h-60 rounded shadow py-6 group relative flex flex-col justify-between">
                      <div className="bg-gray-200 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:aspect-none">
                        <img
                          src={product.logo}
                          alt=""
            ...
            {tab === "Assessment Partners" && (
              ...
              >
                {companies
                  .filter(
                    (company) => company.jobtype === "Assessment Partners"
                  )
                  .map((product, index) => (
                    <div className="w-25 h-25 sm:w-30 sm:h-30 md:w-35 md:h-35 lg:w-46 lg:h-50 xl:w-56 xl:h-60 rounded shadow py-6 group relative flex flex-col justify-between">
                      <div className="bg-gray-200 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:aspect-none">
            ...
            {tab === "Product/Dream Companies" && (
              ...
              >
                {companies
                  .filter(
                    (company) => company.jobtype === "Product/Dream Companies"
                  )
                  .map((product, index) => (
                    <div className="w-25 h-25 sm:w-30 sm:h-30 md:w-35 md:h-35 lg:w-46 lg:h-50 xl:w-56 xl:h-60 rounded shadow py-6 group relative flex flex-col justify-between">
                      <div className="bg-gray-200 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:aspect-none">
            ...
            {tab === "Product/Super Dream" && (
              ...
              >
                {companies
                  .filter(
                    (company) => company.jobtype === "Product/Super Dream"
                  )
                  .map((product, index) => (
                    <div className="w-25 h-25 sm:w-30 sm:h-30 md:w-35 md:h-35 lg:w-46 lg:h-50 xl:w-56 xl:h-60 rounded shadow py-6 group relative flex flex-col justify-between">
                      <div className="bg-gray-200 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:aspect-none">
            ...
            {tab === "FAANG/MAANG" && (
              ...
              >
                {companies
                  .filter((company) => company.jobtype === "FAANG/MAANG")
                  .map((product, index) => (
                    <div className="w-25 h-25 sm:w-30 sm:h-30 md:w-35 md:h-35 lg:w-46 lg:h-50 xl:w-56 xl:h-60 rounded shadow py-6 group relative flex flex-col justify-between">
                      <div className="bg-gray-200 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:aspect-none">
                        <img
...
export const getServerSideProps = async ({ req, res }) => {
  ...
  if (user.category !== "individual") {
    return {
      redirect: {
        destination: `/dashboard/${user.category}/testpatterns`,
        permanent: false,
      },
    };
  }
