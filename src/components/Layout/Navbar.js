...
export const Navbar = () => {
  ...
  const landingNavigation = [
    ...
    {
      name: "Practice",
      href: "/dashboard/individual/practice",
    },
    {
      name: "Assessment",
      href: "/dashboard/individual/assessment",
    },
    // {
    //   name: "Assessments",
    //   href: "/",
  ...
  useEffect(() => {
    ...
    else if (session?.category === "individual")
    ...
    <Popover className="fixed top-0 left-0 z-40 w-full bg-gray-100 h-[10vh]">
      <div className="flex justify-between items-center px-4 sm:px-6 md:justify-start md:space-x-10">
        <div className="flex justify-start lg:w-0 lg:flex-1 ">
          <Link href={"/"} passHref>
            <div className="w-44 h-[10vh] flex items-center py-2">
              <div className="relative h-full w-full flex object-cover rounded-md cursor-pointer">
                <Image
                  placeholder="blur"
                  ...
                  alt=""
                />
                <h1 className="ml-32 pt-3 text-4xl border-l-2 border-black pl-2 font-semibold">
                  CareerGo
                </h1>
              </div>
            </div>
          ...
          {navigation.map((option, index) => (
            <Link key={index} href={option.href}>
              <a
                key={option.name}
                href={option.href}
                className="text-gray-900 hover:text-orange-400 hover:text-lg duration-300 ease-in-out
