      ...
      <div className="max-w-2xl mx-auto py-16 px-4 text-center sm:py-20 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
          ...
          <span className="block text-cyan-900">
            Start using CareerGo today.
          </span>
        </h2>
        <p className="mt-4 text-lg leading-6 text-cyan-100">
          CareerGo aim to provide a platform for those desiring to enter the
          industry, that keeps in mind the various roles, skills, and expertise
          professionals would require to carve a niche for themselves.
        </p>
