...
export const Stylish = ({ componentRef, filter = null }) => {
  ...
  return (
    <div
      ref={componentRef}
      id="template"
      className="w-a4W  mx-auto   h-[296mm] my-5  relative bg-gray-300"
    >
      <div className="flex px-5 py-4">

        {/* left  */}
        <div className="flex-col pt-1 mt-[5%] py-3 pl-1 w-[40%]  bg-white rounded-xl ">
          {/* image */}
          {profile && (
            <div className=" flex text-black   justify-around ">
              <img
                src={profile.image}
                alt=""
                className="w-[50%] h-[50%] rounded-3xl mb-3"
                id="profileImage"
              />
            </div>
          )}
          ...
          {profile && (
            <div className="flex-col bg-zinc-200 py-2">
              <span className=" text-[20px] font-extrabold pl-3 tracking-wide capitalize font-serif ">
                {profile.firstName} {profile.lastName}
              </span>
              <h1 className="  text-[16px] pl-3 tracking-wider font-thin ">
                {profile.role}
              </h1>
            </div>
          )}
                      ...
                      <>
                        {item.enabled && (
                          <div className="text-[12px] px-2 py-1 text-black">
                            ...
                            <h1 className="text-black">{item.summary.data}</h1>
                            )}
                          </div>
                        )}
                      </>
                          ...
                          <div className="text-[12px] px-2 py-1 text-black">
                            <div className="text-black text-[14px] flex justify-between">
                              <div href={item.website} className="">
                               <h1 className="font-semibold text-justify"> {item.company} </h1> 
                               <h1 className="text-justify"> - {item.designation}</h1>
                              </div>
                              <div className="">
                            ...
                            {item.summary.enabled && (
                              ...
                              <h1 className="text-[12px] text-justify text-black">
                        ...
                        {item.enabled && (
                          <div className="text-[13px] py-1 px-2 text-black">
                            ...
                            {item.summary.enabled && (
                              ...
                              <p className="text-[12px] text-justify text-black">
                              {item.summary.data}
                            </p>
                              )}
                          </div>
