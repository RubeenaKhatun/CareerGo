                        ...
                        .map((item) => (
                          <div className="py-1 p-3 ml-6">
                            ...
                            {item.summary.enabled &&(
                              <h1 className="font-normal  text-[12px] mx-0.5 text-xs">
                              <MarkdownRenderer>
                                {item.summary.data}
                              </MarkdownRenderer>
                            </h1>
                ...
                {work
                  ...
                  .map((item) => (
                    <div>
                     ...
                     {item.summary.enabled && (
                       <h1 className="ml-8 list-disc text-[12px] text-justify">
                      ...
                      <h1 className="relative font-semibold ml-4 text-[12px]">
                        ...
                        <div className="">
                          ...
                          <h1 className="font-normal ml-4 text-[12px]">
                            ...
                            {item.summary.enabled && (
                          <h1 className="font-normal ml-4 text-[12px] text-justify "><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
                ...
                {projects
                  ...
                  .map((item) => (
                    <div>
                     ...
                     {item.summary.enabled &&(
                       <h1 className=" ml-8 text-[12px] text-justify"><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
