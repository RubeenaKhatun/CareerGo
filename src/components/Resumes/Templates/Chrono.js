        ...
        <div className="col-span-2 border-2 border-solid border-black h-[270mm] px-2 ml-5 mt-20 ">
          ...
          <div>
            ...
            {profile?.displayEmail == "collegeMail" && (
              <h1 className="font-medium ml-3 mt-2 text-[12px]">{profile?.email}</h1>
            )}
            {profile?.displayEmail == "personalMail" && (
              <h1 className="font-medium ml-3 mt-2 text-[12px]">{profile?.personalEmail}</h1>

              )}
              <h1 className="font-medium ml-3 mt-2 text-[12px]">{profile?.phone}</h1>
            <h1 className="font-medium ml-3 mt-2 text-[12px]">{profile?.dob}</h1>
          </div>
          {skills?.filter((skill) => skill?.enabled)?.length > 0 && (
            <div className="">
              ...
              {skills
                ...
                .map((item) => (
                  <div>
                    <h1 className="font-normal ml-2 mt-2    text-[12px] ">
          ...
          {social?.filter((social) => social?.enabled)?.length > 0 && (
            <div className="">
              ...
              {social
                ...
                .map((item) => (
                  <div className="ml-2    my-2 flex text-[12px]">
                    <img
                ...
                .map((item) => (
                  <div className="mt-2">
                    ...
                    {item.summary.enabled && (
                      <h1 className="text-[12px] ml-2 text-justify"><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
                    )}
                  </div>
                ))}
            </div>
              ...
              {education
                ...
                .map((item) => (
                  <div className="p-1">
                    ...
                    {item.summary.enabled &&(
                      <h1 className="text-[12px] text-justify  ml-2 "><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
              ...
              {certifications
                ...
                .map((item) => (
                  <div className="">
                    ...
                    {item.summary.enabled && (
                      <h1 className=" ml-2 text-[12px] text-justify"><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
                ...
                {projects
                  ...
                  .map((item) => (
                    <div>
                      ...
                      <h1 className=" ml-2 text-[12px]">{item.website}</h1>
                     {item.summary.enabled &&(
                       <h1 className=" ml-2 text-[12px] text-justify"><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
