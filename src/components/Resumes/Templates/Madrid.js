              ...
              {work
                ...
                .map((item) => (
                  <div className="">
                    ...
                    <h1 className="text-[12px] ml-4 text-justify"><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
                ...
                {certifications
                  ...
                  .map((item) => (
                    <div>
                      ...
                      {item.summary.enabled && (
                      <h1 className=" ml-4 text-[12px] text-justify"><MarkdownRenderer>{item.summary.data}</MarkdownRenderer></h1>
