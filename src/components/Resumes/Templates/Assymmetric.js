        ...
        <div className="w-[35%] pl-7">
          ...
          {profile && (
            <div className="pt-3">
              <div className="text-[12px]">
                <h1 className="text-[16px]  font-serif tracking-wider heading font-bold">
                  NETWORK
                </h1>
          ...
          {hobbies?.filter((hobbie) => hobbie?.enabled).length > 0 && (
            <div>
              {hobbies.length != 0 && (
                <div className="pt-3 ">
                  <p className="text-[16px]  font-serif tracking-wider heading font-bold">
                    HOBBIES
                  </p>
                  <div className="pt-1">
                    {hobbies.map((item) => (
          ...
          {skills?.filter((skill) => skill?.enabled).length > 0 && (
            <div className="pt-3">
              <p className="text-[16px] font-bold heading  font-serif tracking-wider">
                SKILLS
              </p>
              <div className="pt-1">
                {skills.map((item) => (
          ...
          {languages?.filter((language) => language?.enabled).length > 0 && (
            <div>
              {languages.length != 0 && (
                <div className="pt-3">
                  <p className="text-[16px] heading font-serif tracking-wider font-bold">
                    LANGUAGES
                  </p>
                  {languages.length != 0 &&
          ...
          {work?.filter((work) => work?.enabled).length > 0 && (
            <div>
              {work.length != 0 && (
                <div className="pt-3">
                  <p className="text-[16px] heading font-serif tracking-wider font-bold pb-1">
                    EXPERIENCE
                  </p>
                  <div className="pt-1">
                    {work.map((item) => (
          ...
          {awards?.filter((award) => award?.enabled).length > 0 && (
            <div className="pt-3">
              {awards.length != 0 && (
                <div className="">
                  <p className="text-black font-bold font-serif heading tracking-wider   py-1 ">
                    AWARDS
                  </p>
                  {awards.map((item) => (
                    <>
                      {item.enabled && (
                        <div key={item.name} className="text-[12px]">
                          ...
                          <h1 className="font-bold pl-2 text-gray-800">
                            {item.name}
                          </h1>
                          <span className="pl-2">
                            [{item.date.slice(0, 4)}]
                          ...
                          {item.summary.enabled && (
                            <h1 className="pl-2 text-justify text-[12px]">
                              {item.summary.data}
                            </h1>
                          )}
                        </div>
        ...
        <div className="w-[65%] px-4 py-2 pb-4 ">
          ...
          <div className=" bg-gray-200 mt-8  rounded-xl p-2">
            {objective && (
              <>
                {objective != 0 && (
                  <>
                    <p className="heading text-black font-serif font-bold text-[16px] px-2 py-1  tracking-wider  ">
                      PROFILE
                    </p>
                    <h1 className="text-[12px] text-justify text-black px-2 pb-2 ">
            ...
            <div>
              {education.length != 0 && (
                <div className="bg-gray-200 rounded-xl p-2 mt-2">
                  <p className="text-black heading font-serif font-bold text-[16px] px-2 py-1 tracking-wide">
                    EDUCATION
                  </p>
                  {education.map((item) => (
                    <>
          ...
          {projects?.filter((project) => project?.enabled).length > 0 && (
            <div>
              {projects.length != 0 && (
                <div className="bg-gray-200 rounded-xl p-2 mt-2">
                  <p className="text-black font-serif font-bold heading text-[16px] px-2 py-1 tracking-wider">
                    PROJECTS
                  </p>
          ...
          {certifications?.filter((certification) => certification?.enabled)
            ...
            <div>
              {certifications.length != 0 && (
                <div className="bg-gray-200 rounded-xl p-2 mt-2 ">
                  <p className="text-black heading font-serif font-bold text-[16px] px-2 py-1 tracking-wider ">
                    CERTIFICATION
                  </p>
